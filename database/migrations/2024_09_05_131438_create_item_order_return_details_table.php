...
return new class extends Migration
{
    ...
    {
        Schema::create('item_order_return_details', function (Blueprint $table) {
            $table->id();
            $table->integer('item_order_return_id')->unsigned();
    ...
    {
        Schema::dropIfExists('item_order_return_details');
    }
};
