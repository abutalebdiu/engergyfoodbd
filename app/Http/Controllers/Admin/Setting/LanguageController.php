...
class LanguageController extends Controller
{
    ...
    {
        Gate::authorize('admin.language.manage');
    ...
    {
        Gate::authorize('admin.language.add_new');
    ...
    {
        Gate::authorize('admin.language.delete');
    ...
    {
        Gate::authorize('admin.language.edit');
        $lang = Language::find($id);
    ...
    {
        Gate::authorize('admin.language.import');
    ...
    public function storeLanguageJson(Request $request, $id)
    {
        ...
        Gate::authorize('admin.language.store.json');
    ...
    {
        Gate::authorize('admin.language.delete.json');
    ...
    {
        Gate::authorize('admin.language.update.json');
