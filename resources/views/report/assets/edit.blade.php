@extends('admin.layouts.app', ['title' => 'Edit Asset'])
@section('panel')
                ...
                <div class="row">
                    ...
                    <div class="pb-3 col-12 col-md-9">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" required value="{{ $asset->title }}">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="price" value="{{ $asset->price }}" id="price"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="4" class="form-control">{{ $asset->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="purchase_date" value="{{ $asset->purchase_date }}" id="purchase_date"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="expired_date" value="{{ $asset->expired_date }}" id="purchase_date"
                                class="form-control">
                        </div>
                    </div>
