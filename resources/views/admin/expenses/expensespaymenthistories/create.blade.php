@extends('admin.layouts.app', ['title' => 'Add New Hotel'])
@section('panel')
    <form action="{{ route('admin.hotel.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">Add New Hotel <a href="{{ route('admin.hotel.index') }}"
                        class="btn btn-outline-primary btn-sm float-end"> <i class="fa fa-list"></i> Hotel List</a>
                </h6>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="pb-3 col-md-3">
                        <div class="form-group ">
                            ...
                            <input class="form-control" type="text" name="room_rate" value="{{ old('room_rate') }}">
                        </div>
                    </div>
