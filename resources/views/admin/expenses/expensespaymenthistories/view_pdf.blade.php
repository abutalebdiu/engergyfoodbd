...
<head>
    ...
    <title> @lang('Expense Payment List') </title>
    <style>
        table {
...
<body>
    <div>
        <div class="wrapper">
            ...
            <h4 style="text-align: center;padding:0;margin:0">@lang('Expense Payment List')</h4>
                 ...
                 <table border="1">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th  style="text-align:right;padding-right:10px"> {{ en2bn(number_format($expensespaymenthistories->sum('amount'),2,'.',',')) }}</th>
                        </tr>
                    </tfoot>
                </table><!-- table end -->
            </div>
