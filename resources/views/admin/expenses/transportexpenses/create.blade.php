@extends('admin.layouts.app', ['title' => 'Add New Transport Expenses'])
@section('panel')
    ...
    <form action="{{ route('admin.transportexpense.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">@lang('Add New Transport Expenses') </h5>
            </div>
            <div class="card-body">
                <div class="row">
