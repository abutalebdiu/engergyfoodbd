@extends('admin.layouts.app', ['title' => 'Add New Monthly Expenses Payment'])
@section('panel')
    ...
    <form action="{{ route('admin.monthlyexpensepayment.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">@lang('Add New Monthly Expense Payment') </h5>
            </div>
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="monthly_expense_id" required>
                                ...
                                @foreach ($monthlyexpenses as $item)
                                    <option {{ old('monthly_expense_id') == $item->id ? 'selected' : '' }}
