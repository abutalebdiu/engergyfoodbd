...
<head>
    ...
    <title> @lang('Monthly Expenses Payment List') </title>
    <style>
        table {
...
<body>
    <div>
        <div class="wrapper">
            ...
            <h4 style="text-align: center;padding:0;margin:0">@lang('Monthly Expenses Payment List')</h4>
                 ...
                 <table border="1">
                    ...
                    <tbody>
                        @forelse($monthlyexpensepayments as $item)
                            <tr>
                                ...
                                <td style="text-align:left"> {{ $item->monthlyexpense?->name }} </td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th  style="text-align:right;padding-right:10px"> {{ en2bn(number_format($monthlyexpensepayments->sum('amount'),2,'.',',')) }}</th>
                        </tr>
                    </tfoot>
                </table><!-- table end -->
            </div>
