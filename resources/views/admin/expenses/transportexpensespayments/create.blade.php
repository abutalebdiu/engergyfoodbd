@extends('admin.layouts.app', ['title' => 'Add New Transport Expenses Payment'])
@section('panel')
    ...
    <form action="{{ route('admin.transportexpensepayment.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">@lang('Add New Transport Expense Payment') </h5>
            </div>
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="transport_expense_id" required>
                                ...
                                @foreach ($transportexpenses as $item)
                                    <option {{ old('transport_expense_id') == $item->id ? 'selected' : '' }}
