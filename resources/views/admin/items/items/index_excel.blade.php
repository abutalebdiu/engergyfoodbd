        ...
        <div class="wrapper">
            <div>
                <table style="text-align: center">
                    ...
                    <tr>
                        <th colspan="5" style="text-align: center">{{ $general->site_name }}</th>
                    </tr>
                    <tr>
                        <th colspan="15" style="text-align: center">{{ $general->address }}</th>
                    </tr>
                    <tr>
                        <th colspan="5" style="text-align: center">অফিস: {{ $general->phone }}, হেল্প
