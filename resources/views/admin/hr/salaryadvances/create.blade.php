@extends('admin.layouts.app', ['title' => 'Add New Salary Advance'])
@section('panel')
    <form action="{{ route('admin.salaryadvance.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">Add New Salary Advance <a href="{{ route('admin.salaryadvance.index') }}"
                        class="btn btn-outline-primary btn-sm float-end"> <i class="bi bi-list"></i> Salary Advance List</a>
                </h6>
            </div>
            <div class="card-body">
                <div class="row">
