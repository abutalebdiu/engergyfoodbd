@extends('admin.layouts.app', ['title' => 'Add New Salary Duduction'])
@section('panel')
    <form action="{{ route('admin.salarydeduction.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">Add New Salary Duduction <a href="{{ route('admin.salarydeduction.index') }}"
                        class="btn btn-outline-primary btn-sm float-end"> <i class="bi bi-list"></i> Salary Duduction List</a>
                </h6>
            </div>
            <div class="card-body">
                <div class="row">
