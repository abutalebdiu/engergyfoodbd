...
@section('panel')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Employee Salary Detail
                <a href="{{ route('admin.salarygenerate.create') }}" class="btn btn-primary btn-sm float-end"> <i
                        class="fa fa-plus"></i> New Proccess</a>
                <a href="{{ route('admin.salarygenerate.index') }}" class="btn btn-primary btn-sm float-end me-3"> <i
                        class="fa fa-list"></i> Back to Lists</a>
            </h5>
        </div>
        <div class="card-body">
