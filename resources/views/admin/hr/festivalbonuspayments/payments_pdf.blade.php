...
<head>
    ...
    <title>@lang('Salary Payment List')</title>
    <style>
        table {
...
<body>
    <div>
        <div class="wrapper">
            ...
            <h5 style="text-align: center;margin: 0;padding:0">@lang('Employee Salary Payment List')</h5>
                    ...
                    <tbody>
                        @forelse($histories as $item)
                            <tr>
                                ...
                                <td> {{ optional($item->salarygenerate->month)->name }} -
                                    {{ optional($item->salarygenerate->year)->name }} </td>
