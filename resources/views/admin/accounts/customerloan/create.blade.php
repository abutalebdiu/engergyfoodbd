@extends('admin.layouts.app', ['title' => 'Add New Customer Loan'])
@section('panel')
    <form action="{{ route('admin.customerloan.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">Add New Customer Loan <a href="{{ route('admin.customerloan.index') }}"
