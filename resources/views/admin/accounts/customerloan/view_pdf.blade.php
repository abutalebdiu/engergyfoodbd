...
<head>
    ...
    <title>@lang('Customer Loan List')</title>
    <style>
        table {
...
<body>
    <div>
        <div class="wrapper">
            ...
            <h5 style="text-align: center;margin: 0;padding:0">@lang('Customer Loan List')</h5>
                ...
                <table border="1">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td> {{ en2bn(number_format($customerloans->sum('amount'))) }}</td>
                            <td> {{ en2bn(number_format($customerloans->sum('interest'))) }}</td>
                            <td> {{ en2bn(number_format($customerloans->sum('total_amount'))) }}</td>
                            <td colspan="2"></td>
                        </tr>
                    </tfoot>
                </table><!-- table end -->
