@extends('admin.layouts.app', ['title' => 'Add New Withdrawal'])
@section('panel')
    <form action="{{ route('admin.withdrawal.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">Add New Withdrawal <a href="{{ route('admin.withdrawal.index') }}"
