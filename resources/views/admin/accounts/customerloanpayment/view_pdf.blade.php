...
<head>
    ...
    <title>@lang('Customer Loan Payment List')</title>
    <style>
        table {
...
<body>
    <div>
        <div class="wrapper">
            ...
            <h5 style="text-align: center;margin: 0;padding:0">@lang('Customer Loan Payment List')</h5>
                ...
                <table border="1">
                    ...
                    <tbody>
                        @forelse($customerloanpayments as $item)
                            <tr>
                                ...
                                <td> {{ $item->date }}</td>
                                <td class="text-start"> {{ optional($item->customerloan)->title }} </td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>{{ en2bn(number_format($customerloanpayments->sum('amount'), 2, '.', ',')) }}</th>
                            <th colspan="2"></th>
                        </tr>
                    </tfoot>
                </table><!-- table end -->
