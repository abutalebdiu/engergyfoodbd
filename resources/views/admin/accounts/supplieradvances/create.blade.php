@extends('admin.layouts.app', ['title' => 'Add New Supplier Advance'])
@section('panel')
    <form action="{{ route('admin.supplieradvance.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">Add New Supplier Advance <a href="{{ route('admin.supplieradvance.index') }}"
