@extends('admin.layouts.app', ['title' => 'Add New Customer Advance'])
@section('panel')
    <form action="{{ route('admin.customeradvance.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">Add New Customer Advance <a href="{{ route('admin.customeradvance.index') }}"
