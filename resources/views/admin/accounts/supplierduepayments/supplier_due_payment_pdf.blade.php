...
<head>
    ...
    <title>@lang('Supplier Due Payment List')</title>
    <style>
        table {
...
<body>
    <div>
        <div class="wrapper">
            ...
            <h5 style="text-align: center;margin: 0;padding:0">@lang('Supplier Due Payment List')</h5>
                    ...
                    <tbody>
                        @forelse($supplierduepayments as $item)
                            <tr>
                                ...
                                <td style="text-align: left;padding-left:10px"> {{ optional($item->supplier)->name }}
                                </td>
                                <td> {{ optional($item->paymentmethod)->name }} </td>
                                <td> {{ optional($item->account)->title }} </td>
                                <td style="text-align: right;padding-right:10px">
                                    {{ en2bn(number_format($item->amount, 2, '.', ',')) }}</td>
