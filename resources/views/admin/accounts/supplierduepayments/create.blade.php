@extends('admin.layouts.app', ['title' => 'Add New Supplier Due Payment'])
@section('panel')
    <form action="{{ route('admin.supplierduepayment.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">Add New Supplier Due Payment <a href="{{ route('admin.supplierduepayment.index') }}"
