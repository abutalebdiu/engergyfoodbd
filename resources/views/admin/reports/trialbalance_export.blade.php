...
<head>
    ...
    <title>@lang('Trial Balance')</title>
    <style>
        table {
...
<body>
    <div>
        <div class="wrapper">
            ...
            <h5 style="text-align: center;margin: 0;padding:0;border-bottom:1px solid #000">@lang('Trial Balance')</h5>
                        ...
                        <table border="1">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <th colspan="2">{{ en2bn(number_format($availablebalance + $totalincome - $totalexpenditure), 2, '.', ',') }} </th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
