@extends('admin.layouts.app', ['title' => 'Service Invoice List'])
@section('panel')
    <!--breadcrumb-->
    <div class="page-breadcrumb d-flex align-items-center mb-2 border-bottom pb-2">
        <div>
            <h6 class="m-0">Service Invoice List</h6>
        </div>
        <div class="ms-auto">
            <a href="{{ route('admin.serviceinvoice.create') }}" type="button" class="btn btn-primary btn-sm"> <i
                    class="bi bi-plus-circle"></i> Make Invoice </a>
        </div>
    </div>
    <!--breadcrumb-->
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="{{ route('admin.serviceinvoice.edit', $item->id) }}"
