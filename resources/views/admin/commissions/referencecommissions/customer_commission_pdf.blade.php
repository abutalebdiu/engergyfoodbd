...
<head>
    ...
    <title>@lang('Customer Commission Product Wise')</title>
    <style>
        table {
...
<body>
    <div>
        <div class="wrapper">
            ...
            <h5 style="text-align: center;margin: 5px 0;padding:0">@lang('Customer Commission Product Wise')</h5>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: left;width:1%">:</td>
                            <td style="text-align: left;width:40%">{{ en2bn($customer->uid) }}</td>
                        </tr>
                        <tr>
                            <th style="text-align: left;width:9%">@lang('Mobile')</th>
                            <td style="text-align: left;width:1%">:</td>
                            <td style="text-align: left;width:40%">{{ $customer->mobile }}</td>
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ en2bn($product->productCommission?->price ?? $product->sale_price) }}</td>
                                        <td>{{ en2bn($product->productCommission?->amount ?? 0) }}</td>
                                        <td>{{ $product->productCommission?->type   }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
